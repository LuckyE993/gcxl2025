...
void MX_FREERTOS_Init(void)
{
  ...
  osThreadDef(motor, motor_task, osPriorityHigh, 0, 256);
  motor_handle = osThreadCreate(osThread(motor), NULL);
  osThreadDef(main, main_task, osPriorityNormal, 0, 128);
