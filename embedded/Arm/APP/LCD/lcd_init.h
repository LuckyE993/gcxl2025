...
//-----------------LCD端口定义----------------
#define LCD_MOSI_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_5)//SDI=MOSI
#define LCD_MOSI_Set() GPIO_SetBits(GPIOB,GPIO_Pin_5)

#define LCD_SCLK_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_4)//SCL=CLK
...
#define ZK_CS_Set()    GPIO_ResetBits(GPIOB,GPIO_Pin_8)//CS
#define ZK_CS_Clr()    GPIO_SetBits(GPIOB,GPIO_Pin_8)
